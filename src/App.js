...
import { FaCode, FaFacebook, FaGithub, FaInstagram, FaLink, FaLinkedinIn } from 'react-icons/fa'
    ...
    <div className={`screen-container ${val?'screen':''} Resume container-main`}>
      ...
      <div className='col-lg-5 personal-details justify-content-center'>
        <div className='col-12'>
          ...
          <div className='row'>
              <a href='mailto:hrsharma@iitk.ac.in' className='col-md-6 text'><span className='span-text'>Email:</span> {'hrsharma@iitk.ac.in'}</a>
      ...
      <div className='col-lg-7 projects-section align-self-center'>
        <div className='row card-console'>
...
function Projects({val}){
  ...
  const [pval, setpval] = useState({1:1})
  return (
    <div className={`screen-container ${val?'screen':''} container-main  `}>
      ...
      <div className='row col-lg-11 col-md-12 justify-content-center'>
        {Object.keys(projectData).map((val,index) => (
          <div onClick={() => {setpval(projectData[val])}} className='col-lg-4 col-md-6'>
    ...
    <div className={`screen-container ${val?'screen':''} container-main  `}>
      ...
      <div className='row'>
        <div className='col-lg-6'>
            ...
            }} placeholder='NAME' className='col-12 contact-input'/>
            </div>

            <div className='col-md-6'>
            <input onChange={(e) => {
              setForm(val => ({...val,email:e.target.value}))
            }} placeholder='EMAIL' className='col-12 contact-input'/>
            </div>
            ...
            }} placeholder='SUBJECT' className='contact-input col-12'/>    
            </div>
            <div className='col-md-12'>
            <textarea onChange={(e) => {
              setForm(val => ({...val,message:e.target.value}))
            }} placeholder='MESSAGE' className='col-12 contact-message'/>
            <button className='col-md-4 col-sm-6 contact-submit'>
              SUBMIT
            </button>
            </div>
        ...
        <div className='col-lg-5 contact-info'>
          <div className='row justify-content-center'>
            ...
            <a href='mailto:hrsharma@iitk.ac.in' className='text-contact'><span className='span-text'>EMAIL:</span> hrsharma@iitk.ac.in</a>
